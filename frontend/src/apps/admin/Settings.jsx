...
const GROUPS = [
  {
    ...
    label: 'AI Review',
    icon:  '🤖',
    keys:  ['ai_review_threshold', 'auto_publish_enabled'],
    note:  'Controls automatic article publishing after Claude Haiku review.',
  },
  {
    key:   'quality',
    label: 'Content Quality',
    icon:  '📋',
    keys:  ['min_paragraph_blocks', 'min_word_count'],
    note:  'Minimum content requirements for scraped pages to be saved as articles.',
  },
  {
    key:   'scraper',
    label: 'Scraper',
    icon:  '🔍',
    keys:  ['max_searches_per_job'],
    note:  'Governs how many URLs are processed on each scrape job run.',
  },
  {
    key:   'trends',
    label: 'Trends',
